...
<body>				
	<div class="print-area"> 	
		...
		<table class="noborder" style="margin-left:auto;margin-right:auto;width:580px;border:1px solid;">		
 ...
 whose particulars are given below admitted as a day scholar in your School :</td>  					
	  ...
	  <br/>			
	  <div class="print-area" style="height:950px;"> 			
 ...
 the term and conditions enclosed with the registration form.</td>		
		...
		<table class="table noborder" style="margin-left:auto;margin-right:auto;width:580px;">
			<tbody> 
				<tr>
