...
@endforeach     
        <table cellpadding="0" cellspacing="0">		
            ...
            <tr><td align="left"><b>Phone No:</b>{{$school[0]->school_contact}}</td><td align="right"><b>Affiliation No:</b>{{$school[0]->school_affiliation}}</td></tr>
            <tr><td align="left"><b>Website:</b> {{$school[0]->server_address}} </td><td align="right"><b>Email:</b> {{$school[0]->school_email}}</td></tr>     
