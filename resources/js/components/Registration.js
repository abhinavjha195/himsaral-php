...
hasErrorFor (field) {
  ...
  formSubmit(event){
	...
	axios.post(`${base_url}api`+'/registration/create',fd)
	.then(response => {
		console.log(response.data);
...
************************************/}
      ...
      ************************************/}
      ...
      <div className="content-bodys my-4">
          ...
          <div className="row page-titles mx-0">
            ...
            <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
              <ol className="breadcrumb">
				<li><a href={`/login`} className="btn bg-blue-soft text-blue"><i className="fa fa-angle-double-left"></i> Back to Sign-in</a></li>
              </ol>
            </div>
          </div>
          {/* row */}
