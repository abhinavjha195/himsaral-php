...
class DepartmentAdd extends Component {
    ...
    handleCreateNewItem(event) {
        ...
        axios.post(`${base_url}api`+'/department/create', data)
            .then(response => {
                                                    ...
                                                    <div className="form-row">
                                                        <div className="form-group col-md-6">
                                                            ...
                                                            <input type='text' className={`form-control ${this.hasErrorFor('title') ? 'is-invalid' : ''}`} name='title'
                                                                ref={this.input} placeholder="Enter department name" />{this.renderErrorFor('title')}
                                                        </div>
                                                        <div className="form-group col-md-12">
                                                            <input type="submit" className="btn btn-primary mr-2" value="Add Department" />
                                                        </div>
                                                        <div className="form-group col-md-12">
