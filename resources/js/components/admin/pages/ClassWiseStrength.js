...
class ClassWiseStrength extends Component {
    constructor() {
        super();
        this.state = {
            showError: false,
...
//return null;  		
        ...
        const url = base_url+'api/classwisestrength/index';		
        const columns = ['courseName', 'className', 'sectionName', 'maleCount', 'femaleCount'];

        let _this = this;

        const options = {
            perPage: 10,
            headings: { courseName: 'Course Name', className: 'Class Name', sectionName: 'Section Name', maleCount: 'MALE', femaleCount:'FEMALE'},
            sortable: ['courseName', 'className', 'sectionName', 'maleCount', 'femaleCount'],
                                    ...
                                    <div className="card">
                                        <div className="card-body create-user-table">
                                            <div className="table-responsive" style={{height:"750px"}}>		
                                                <ServerTable ref={this.serverTable} columns={columns} url={url} options={options} bordered condensed hover striped>	
                                                    {
                                                        function (row, column) {
															return row[column];
                                                        }
