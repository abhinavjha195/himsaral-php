                ...
                <div className="row page-titles mx-0">
                    <div className="col-sm-6 p-md-0">
                        <div className="welcome-text">
                            <h4>Full Attendance Report Preview</h4>
                        </div>
                    </div>
                </div>
									  ...
									  <div className="col-md-12 left">
									    <div className="form-row">
										  <div className="form-group col-sm-8">
										    <label> Select one of the RadioButtons to see the Details*</label>
                                          ...
                                          <label>&nbsp;</label>
                                            <button type="button" className="btn btn-primary load-fee" onClick={this.loadFee} disabled={this.state.isSpinner}>Load Detail <span className="kt-spinner kt-spinner--sm kt-spinner--right kt-spinner--light" style={{ display: this.state.isSpinner ? 'inline' : 'none' }}></span></button>
										  </div>
                                            {
											    (showCount>0)?(
                                                    <>
                                                    <div className="form-group col-md-2">
                                                        <span style={{"color":"#832224","fontWeight":"bold"}}>Student Name:</span>
                                                    </div>
                                                    <div className="form-group col-md-2">
                                                        <label className="feeclass" style={{"marginLeft":"-44%"}}>Nikhil Sharma</label>
                                                    </div>
                                                    <div className="col-md-2">
                                                        <span style={{"color":"#832224","fontWeight":"bold", "marginLeft": "-46%"}}>Father Name :</span>
                                                    </div>
                                                    <div className="form-group col-md-2">
                                                        <label className="feeclass" style={{"marginLeft": "-87%"}}>Raman</label>
                                                    </div>
                                                    <div className="col-md-1">
                                                        <span style={{"color":"#832224","fontWeight":"bold","marginLeft":"-168%"}}>Class :</span>
                                                    </div>
                                                    <div className="form-group col-md-2">
                                                        <label className="feeclass" style={{"marginLeft": "-90%"}}>Sr. Secondary(10+1)</label>
                                                    </div>
                                                    </>
                                                ):''
                                            }
										  ...
										  {
											(showCount>0)?(
										    <input type="button" value="Load Previous Fee Detail" className="btn btn-info btn-sm" name="Load Previous Fee" onClick={this.previousFee}/>
											):''
										  }
										  </div>
								...
								<div className="amount-code form-own">
								  <div className="row">
								    ...
								    <div className="col-sm-6">
                                      ...
                                      <button type="button" className="btn btn-primary btn-sm mx-1"> Pay </button>
