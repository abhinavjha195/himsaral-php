...
class ClassWiseSubjectCreate extends Component {
...
constructor (props) {
  ...
  const subjects=this.state.subData;
  const ranks = this.state.rankArr;
  const electives = this.state.elecArr;
  const extras = this.state.adoArr;
  const priorities=this.state.prtArr;
  ...
  for(var key in subjects)
  {
	  ...
	  {
		 subjectarr.push(subjects[key].subjectId);
	  }
  }
  ...
  {
	  if(!adoarr.includes(parseInt(extras[key])))
	  {
  ...
  const data = {
	course_id:courseid,
	class_id:classid,
	section_arr:sectionarr,
	subject_arr:subjectarr,
	rank_arr:rankarr,
	elective_arr:elecrr,
	aditional_arr:adoarr,
	priority_arr:prtarr,
  }

  axios.post(`${base_url}`+'api/add_class_wise_sub_process',data)
    .then(response => {
		...
		<div className="row page-titles mx-0">
			<div className="col-sm-6 p-md-0">
				<div className="welcome-text">
					<h4>Add Class wise Subjects</h4>
				</div>
			</div>
			<div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
				<ol className="breadcrumb">
					<li><a href={`/class_wise_subject_list`} className="btn bg-blue-soft text-blue">
					<i className="fa fa-angle-double-left"></i> Back to Class Wise Subjects List</a></li>
				</ol>
			</div>
		</div>
				  ...
				  <form onSubmit={this.handleCreate}>
					...
					<div className="form-row">
					  <div className="form-group col-md-6">
						...
						<select className={`form-control input-daterange-timepicker ${this.hasErrorFor('course_id') ? 'is-invalid' : ''}`} name="course_id" value={this.state.course_id}  onChange={this.handleCourse}>
					  ...
					  <div className="form-group col-md-6">
						...
						<select className={`form-control input-daterange-timepicker ${this.hasErrorFor('class_id') ? 'is-invalid' : ''}`} name="class_id" onChange={ this.handleClass} value={this.state.class_id}>
...
export default ClassWiseSubjectCreate;
